						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" src="source/image/product/{{$product['item']->image}}" alt="" class="pull-left" height="50%">
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{isset($totalPrice)?number_format($totalPrice,2):0}}</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
							...
							<div class="text-center"> <button type="submit" a class="beta-btn primary" href="">Đặt hàng <i class="fa fa-chevron-right"></i></a></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
